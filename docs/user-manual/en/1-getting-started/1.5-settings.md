...
- Checking for updates (this fork has no in-app auto-updater; the button opens the GitHub releases page so you can download and install new builds manually)
