...
pub use deeplink::{
    deeplink_error_payload, import_provider_from_deeplink, parse_deeplink_url,
...
pub fn run() {
    ...
    let builder = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::is_claude_desktop_installed,
            commands::is_codex_desktop_installed,
            ...
            commands::preview_grok_privacy_protection,
            commands::list_grok_config_backups,
            commands::restore_grok_config_backup,
            commands::delete_grok_config_backup,
